...
from simulation.constants import CONTROLLER_COMMIT_ID
...
from lightning.modules.receptacle_module import ReceptacleModule
from shared.constants import (CLASSES_TO_IGNORE, IMAGE_SIZE, NORMALIZE_RGB_MEAN,
                                  NORMALIZE_RGB_STD)
from shared.utils import check_none_or_empty
from simulation.shortest_path_navigator import (AgentLocKeyType,
